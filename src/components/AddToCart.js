        ...
        <div class="row">
          <div class="col-xl-8 col-lg-8  mb-5">
              ...
              <div class="add-to-cart-box">
                <div class="row">
                  ...
                  <div class="col-xl-7 col-lg-6 col-sm-6">
                    <div class="cart-item">
                      <h4 class="mt-4">
                        Mediphrma Online Pharmacy Store <br /> Flutter Full App
                        UI Kit
                      </h4>
                      <h3 class="mt-4">$85</h3>
                      <div class="row mt-4">
                        <div class="col-xl-10 col-lg-8 col-sm-8 col-10">
                          <button
                            type="button"
            ...
            <div class="col-xl-12 mt-5">
              <div class="add-to-cart-box">
                <div class="row">
                  <div class="col-xl-5 col-lg-5 col-sm-6">
                    <img src="img/cart-item-2.png" class="img-fluid" />
                  </div>
                  <div class="col-xl-7 col-lg-6 col-sm-6">
                    <div class="cart-item">
                      <h4 class="mt-4">Active eCommerce Flutter App</h4>
                      <h3 class="mt-4">$65</h3>
                      <div class="row mt-4">
                        <div class="col-xl-10 col-lg-8 col-sm-8 col-10">
                          <button
          ...
          <div class="col-xl-4 col-lg-4 mt-5">
            <div class="badge-section">
              ...
              <h3 class="mt-5 mb-4 text-center">$ 150</h3>
              <a href="check-out.html">
                <button
                  type="button"
                  class="btn btn-warning primary-button center-section center-responsive mt-3 mb-4"
                >
                  Checkout
                </button>
              </a>
